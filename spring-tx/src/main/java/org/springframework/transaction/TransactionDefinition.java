...
public interface TransactionDefinition {
	...
	/**
	 * 最常用的级别，如果当前上下文有事务存在，则加入当前事务执行，没有则创建一个
	 * 新的事务
	...
	/**
	 * 总是以没有事务状态执行，如果有事务，则将当前事务挂起
	 * 不支持当前事务，且总以  non-transactionally 执行
